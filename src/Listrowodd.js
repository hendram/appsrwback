...
return(
  <div className="div-table-rowodd">
                  ...
                  <div className="colodd1textspan">{props.dataodd.nama}
                    </div></div>
                <div className="div-table-colodd2">
                  <div className="colodd2textspan">{props.dataodd.tempatlahir}
                        </div></div>
                <div className="div-table-colodd3">
                     <div className="colodd3textspan">{props.dataodd.tgllahir}
                     </div></div>
                  <div className="div-table-colodd4">
                     <div className="colodd4textspan">{props.dataodd.nohp}
                        </div></div>
                <div className="div-table-colodd5">
                   <div className="colodd5textspan">{props.dataodd.tower}
                     </div></div>
                <div className="div-table-colodd6">
                   <div className="colodd6textspan">{props.dataodd.unit}
                     </div></div>
                <div className="div-table-colodd7">
                   <div className="colodd7textspan">{props.dataodd.status}
                     </div></div>
                <div className="div-table-colodd8">
                   <div className="colodd8textspan">{props.dataodd.periodsewa}
                     </div></div>
                <div className="div-table-colodd9">
                   <div className="colodd9textspan">{props.dataodd.agen}
                     </div></div>
                <div className="div-table-colodd10">
                   <div className="colodd10textspan">{props.dataodd.emergencyhelp}
                     </div></div>
